...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { away_bet: @bet.away_bet, game_id: @bet.game_id, home_bet: @bet.home_bet, points: @bet.points, user_id: @bet.user_id }
    end
  ...
  test "should update bet" do
    put :update, id: @bet, bet: { away_bet: @bet.away_bet, game_id: @bet.game_id, home_bet: @bet.home_bet, points: @bet.points, user_id: @bet.user_id }
    assert_redirected_to bet_path(assigns(:bet))
  end
